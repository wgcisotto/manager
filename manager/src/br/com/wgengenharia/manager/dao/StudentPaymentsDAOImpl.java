...
public class StudentPaymentsDAOImpl extends DAOImpl<StudentPayments, Integer> implements StudentPaymentsDAO {
	...
	public List<StudentPayments> listStudentPaymentsLate(Calendar day,
			Branch branch) {
		TypedQuery<StudentPayments> query = em.createQuery("from StudentPayments o where o.branch = :branch and o.expiry_date < :day and o.paid = 0 and o.student.locking = 0", StudentPayments.class);
		query.setParameter("branch", branch);
