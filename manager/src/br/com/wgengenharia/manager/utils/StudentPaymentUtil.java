...
public class StudentPaymentUtil {
	...
	public static String generateStudentPaymentBarcode(StudentPayments studentPayment){
		return COUNTRY_CODE+String.format(ZERO_FILL,studentPayment.getId_student_payments())+codeResult(COUNTRY_CODE + String.format(ZERO_FILL,studentPayment.getId_student_payments()));
	}
